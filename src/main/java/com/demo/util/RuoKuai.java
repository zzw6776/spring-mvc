...
public class RuoKuai {
    ...
    public static String createByPost(String username, String password,
        ...
        byte[] data = getStreamBytes(inputStream);
        //FileUtils.writeByteArrayToFile(new File("/Users/zzw/Downloads/1.png"),data);
    ...
    public static String createByPost(String username, String password,
        ...
        String param = String
            .format(
                "username=%s&password=%s&typeid=%s&timeout=%s&softid=%s&softkey=%s",
                username, password, 3040, 30, "107068",
                "d9cf1230555845adb0c1419bbc073cd6");
    ...
    public static void main(String[] args) throws Exception {
        ...
        HttpGet httpGet = new HttpGet(
            "https://authcode.jd.com/verify/image?a=1&acid=634a3a3d-2a52-45ea-8bdd-3b474b1c9824&uid=634a3a3d-2a52-45ea-8bdd-3b474b1c9824&yys=1529925079277");
        ...
        String byPost = createByPost("", "", "3040", "600", "107068",
            "d9cf1230555845adb0c1419bbc073cd6", inputStream);
